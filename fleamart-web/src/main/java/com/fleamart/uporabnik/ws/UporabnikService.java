 ...
 * 
 */
@WebServiceClient(name = "UporabnikService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:1691/UporabnikService.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:1691/UporabnikService.svc?wsdl");
