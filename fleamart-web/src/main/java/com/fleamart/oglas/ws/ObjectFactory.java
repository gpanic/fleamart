...
public class ObjectFactory {
    ...
    private final static QName _OglasAvtor_QNAME = new QName("http//www.fleamart.com/", "Avtor");
    ...
    public JAXBElement<Uporabnik> createOglasAvtor(Uporabnik value) {
        return new JAXBElement<Uporabnik>(_OglasAvtor_QNAME, Uporabnik.class, Oglas.class, value);
    }
    ...
    public JAXBElement<Uporabnik> createKomentarAvtor(Uporabnik value) {
        return new JAXBElement<Uporabnik>(_OglasAvtor_QNAME, Uporabnik.class, Komentar.class, value);
    }
